...
function(a) {
    a.fn.smoothScroller = function(b) {
        b = a.extend({},
        a.fn.smoothScroller.defaults, b);
        var c = a(this);
    ...
    a("body").on("click", "[data-smoothscroller]",
    function(b) {
        b.preventDefault();
    ...
    a.fn.toc = function(b) {
        ...
        this.each(function() {
            ...
            g.each(function(d, f) {
                ...
                var i = g.text().replace(/[()&^!@#$%^*+`,./?<>\[\]:]/gi, "").replace(/\s+/g, "-").toLowerCase(); // 与GitHub自动生成的anchor名字规则就一致啦，哈哈哈
                
                /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
                 * 如何实现Github markdown 页内跳转https://www.zhihu.com/question/58630229
                 * Github Flavored Markdown   
                 * ruby Anchor的生成规则参见 https://github.com/jch/html-pipeline/blob/master/lib/html/pipeline/toc_filter.rb
                 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
                 */
                /* http://tool.chinaz.com/tools/unicode.aspx 可以在线查询中文字符与Unicode编码的关系
                 */
                i = i.replace(/[\u2010-\u201b]/g, "-")
                i = i.replace(/[\u201c-\u201d]/g, "")      // 中文字符与Unicode编码对应关系 “”就是 \u201c \u201d
                i = i.replace(/[\u3000-\u301F]/g, "")
                i = i.replace(/[\uff00-\uff2F]/g, "")  // 中文字符与Unicode编码对应关系 ，对应 \uff0c
                /* 与GitHub自动生成的anchor名字规则就一致 之后，这个东东就不需要再加啦，哈哈哈哈
                if (f.id !== i) {
                    a("<span/>").attr("id", i).insertBefore(g)
                } */
                
                var l = a("<a/>").text(e.headerText(d, f, g)).attr("href", "#" + i).bind("click",
                function(c) {
